    ...
    <div class="settings__body">
      ...
      <div v-if="isChangingEmail" class="settings__email_edit">
        ...
        <VeeForm @submit="changeEmail">
          <UiFormField name="new-email" label="Новый e-mail" v-model="newEmail" rules="required|email" />
          <UiFormField name="reauth-password" label="Пароль" v-model="password" type="password" rules="required" />
      ...
      <div v-if="isChangingPassword" class="settings__password_edit">
        ...
        <VeeForm @submit="changePassword">
          <UiFormField name="reauth-password" label="Старый пароль" v-model="password" type="password" rules="required" />
          <UiFormField name="new-password" label="Новый пароль" v-model="newPassword" type="password" rules="required|min:6" />
          <div class="form__btn-group">
            <button class="btn btn_ghost" @click.prevent="cancel">Отмена</button>
            <button class="btn btn_blue">Сохранить изменения</button>
          </div>
